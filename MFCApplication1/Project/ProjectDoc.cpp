...
CProjectDoc::CProjectDoc() noexcept
{
...
void CProjectDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CProjectDoc::InitializeSearchContent()
{
...
void CProjectDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
